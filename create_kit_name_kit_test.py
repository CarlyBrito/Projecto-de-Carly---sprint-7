...
def test_create_kit_1_letter_in_first_name_get_success_response():
    kit_body_1 = {"name": "a"}
    sender_stand_request.positive_assert(kit_body_1)
...
def test_create_kit_512_letter_in_name_get_success_response():
    ...
    sender_stand_request.negative_assert_code_400(kit_body_4)
...
def test_create_kit_caracter_special_in_name_get_success_response():
    kit_body_5 = {"name": "$%&@,"}
    sender_stand_request.positive_assert(kit_body_5)
...
def test_create_kit_caracter_space_in_name_get_success_response():
    ...
    sender_stand_request.positive_assert(kit_body_6)

# Prueba 7 -positive
# Se permiten numeros
def test_create_kit_caracter_number_in_name_get_success_response():
    kit_body_7 = {"name": "123"}
    sender_stand_request.positive_assert(kit_body_7)
...
def test_create_kit_caracter_x_in_name_get_success_response():
    kit_body_8 = {}
    sender_stand_request.negative_assert_code_400(kit_body_8)
...
def test_create_kit_caracter_strangernumber_in_name_get_success_response():
    kit_body_9 = {"name": 123}
    sender_stand_request.negative_assert_code_400(kit_body_9)
